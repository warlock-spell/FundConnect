...
class ControllerForm(forms.ModelForm):
    class Meta:
        model = Controller
        fields = ('name', 'email', 'refund_on_exit', 'dividend_interest', 'pay_off_period_of_dividend',
                  'loan_interest', 'loan_interest_period', 'service_fee_interest', 'service_fee_period')
        labels = {"name": "Name", "email": "Email", "refund_on_exit": "NRD",
        ...
        widgets = {
            ...
            'refund_on_exit': forms.NumberInput(attrs={
                'class': INPUT_CLASSES,
            }),
